            ...
            '<div class="form-horizontal capsule">'+
                ...
                '<div class="col-sm-10">'+
                  '<div class="" >'+
                    '<label class="control-label">'+
                      '<input type="checkbox" class="knockout_checkbox" style="top:4px">'+
              ...
              '<div class="dropdown_format_menu">'+
                  ...
                  '<div class="col-sm-4" style="padding: 0;">'+
                    '<div style="padding: 1px">'+
                      '<label class="control-label mandatory_checkbox_label">'+
                        '<input type="checkbox" class="mandatory_checkbox" style="top:4px"> Mandatory'+
                      '</label>'+
                    '</div>'+
                  '</div>'+
                '</div>'+
                ...
                '<div class="form-group form-group-sm hidden placeholder_text_data" style="">'+
                  ...
                  '<div class="col-sm-10">'+
                    '<input type="text" class="form-control placeholder_text" value="Enter Something" disabled>'+
                  '</div>'+
                '</div>'+
              '</div>'+
                 ...
                 '<div class="col-sm-10">'+
                   ...
                   '<div class="knockout_li_checkbox hidden">'+
                      ...
                      '<div class="radio no-padding">'+
                        '<label class="control-label">'+
                          '<input type="radio" name="checkbox" value="true">'+
                          'Checked'+
                        '</label>'+
                      '</div>'+
                      '<div class="radio no-padding">'+
