                                    ...
                                    <tr>
                                       ...
                                       <td class="col-md-10 col-sm-12 col-xs-12">
                                          <div class="statement">
                                             <div class="row">
                                                <div class="single-line-ellipsis">
                                                   <a data-toggle="modal" data-target="#submission_modal">Very cool Number</a>
                                    ...
                                    <div class="form-group form-group-sm">
                                       ...
                                       <div class="col-sm-9">
                                          <div class="checkbox">
                                             ...
                                             <div @if($edit_test_settings->email_verification == 1) class="help-block hidden" @else class="help-block hidden" @endif id="enable_verification_bloc">(The candidate will not be able to resume the test in case of system failure)
                                          </div>
                  ...
                  <div class="col-md-10 col-md-offset-1">
                     ...
                     <div class="modal-content s_modal s_blue_color_modal">
                        ...
                        <div class="modal-body s_modal_body">
                           ...
                           <div class="f_upload_btn">
                              Upload Media
                              <input type="file" name="media" class="message_success_change" data-message="Message ABC" >
                           </div>
                        </div>
                     </div>
                     <br>
                  ...
                  <form name="mcq" action="{{route('update_partial_question')}}" method="post">
                     ...
                     <div class="form-group">
                        <div class="form-inline">
                           ...
                           <div class="pull-right">
                              <a target="_blank" href="{{route('library_public_questions')}}?modal=modal_pencil" class="btn-sm btn-link" data-toggle="tooltip" data-placement="top" title="Edit Question">
            ...
            <div style="">
               <div class="content-area content-area-70 new-question">
                  <form name="coding" action="{{route('update_partial_question')}}" method="post">
                     {{csrf_field()}}
                     <input type="hidden" name="question_id" id="coding_question_id" value="">
                     <div class="form-group">
                        <div class="form-inline">
