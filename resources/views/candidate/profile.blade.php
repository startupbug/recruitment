   ...
   <div class="user-profile page-header">
         ...
         <div class="col-md-10 col-md-offset-1 row">
            ...
            <div class="col-md-7" style="margin-top:4px">
               <div class="progress" style="height:15px">
                  <div class="progress-bar ng-binding" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="@if($total_progress) width:{{$total_progress}}%; @else width: 0%; @endif  line-height:15px;font-size:13px;">
                     @if($total_progress) {{$total_progress}}% @else  0% @endif
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="personal-info" style="margin-top:10px">
         <div class="container">
            ...
            <div class="user-info">
               <div class="row">
                  <div class="col-xs-9 edit_profile hidden">
                     <form id="UpdateCanInfo" name="profileBasic" class="form-horizontal" action="{{route('update_can_info')}}" method="post">
                        ...
                        <button type="button" class="btn btn-sm btn-danger cancel_edit_profile" >Cancel</button>
                     </form>
                  </div>
                  <div class="col-xs-9 view_profile">
                     <span style="font-size: 20px;font-weight: bold;line-height: 20px;">
                     {{Auth::user()->name}}
                     </span>
                     <span>({{Auth::user()->profile->gender}}</span><span>, {{Auth::user()->profile->age}})</span><br>
                     <span style="font-size: 12px;line-height: 12px;">{{Auth::user()->profile->address}}</span><br>
                     ...
                     <div style="line-height: 40px;" class="">
                        <a href="{{route('can_profile_view')}}" class="profile-link">View my public profile</a>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="panel-body">
               <ul>
                  ...
                  <li class="panel-block">
                     ...
                     <a href="{{route('delete_candidate_language',['id'=>$value->id])}}" data-message="get" class="delete_candidate_language">x</a>
                     </span>
                     @endforeach()
                     <!-- foreach end -->
                  </li>
            ...
            <div class="panel-body">
               <ul>
                  ...
                  <li class="panel-block">
                     ...
                     <a href="{{route('delete_candidate_framework',['id'=>$value->id])}}" data-message="get" class="delete_candidate_framework">x</a>
                     </span>
                     @endforeach()
                     <!-- foreach end -->
                  </li>
               ...
               <ul class="ul_add">
                  ...
                  <li class="panel-block">
                     <div class="row">
                        <div class="education_list_data">
                           ...
                           <div class="col-xs-4">
                              <ul class="nav-links navbar-nav navbar-right">
                                 @if(!$loop->first)
                                 <li>
                                    <a href="{{route('candidate_work_move_up',['id'=>$value->id])}}">Move up</a>
                                 </li>
                                 @endif
                                 @if(!$loop->last)
                                 <li>
                                    <a href="{{route('candidate_work_move_down',['id'=>$value->id])}}">Move down</a>
                                 </li>
                                 @endif
                                 <li>
                                    <a href="" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                       ...
                                       <li>
                                          <a href="{{route('delete_candidate_work_info',['id'=>$value->id])}}" data-message="get" class="delete_candidate_work_info">Delete</a>
                                       </li>
                                    </ul>
                                 </li>
                              </ul>
                        ...
                        <div class="col-xs-12 education_list_form hidden">
                           <form class="form-horizontal add_eduation_form editcandidateWorkStore" action="{{route('editcandidateWorkStore',['id'=>$value->id])}}" method="post" name="profileWorkExperience">
                              {{csrf_field()}}
                              <input type="hidden" name="user_id" value="{{Auth::user()->id}}">
                              <div class="form-group form-group-sm">
                                 <label class="col-sm-4 control-label">Job Title*</label>
                                 <div class="col-sm-4">
                                    <input type="text" class="form-control" placeholder="Job Title" name="job_title" value="{{$value->job_title}}" required>
                                 </div>
                                 <div class="control-label" style="text-align:initial">(Required)</div>
                              </div>
                              <div class="form-group form-group-sm">
                                 <label class="col-sm-4 control-label">Company*</label>
                                 <div class="col-sm-4">
                                    <input type="text" class="form-control" placeholder="Company" name="company" value="{{$value->company}}" required>
                                 </div>
                                 <div class="control-label" style="text-align:initial">(Required)</div>
                              </div>
                              <div class="form-group form-group-sm">
                                 <label class="col-sm-4 control-label">Location</label>
                                 <div class="col-sm-4">
                                    <input type="text" value="{{$value->location}}" class="form-control" placeholder="Location" name="location">
                                 </div>
                              </div>
                              <div class="form-group form-group-sm">
                                 <label class="col-sm-4 control-label">Duration*</label>
               ...
               <ul class="ul_add">
                  ...
                  <li class="panel-block">
                     <div class="row">
                        <div class="education_list_data">
                           ...
                           <div class="col-xs-4">
                              <ul class="nav-links navbar-nav navbar-right">
                                 @if(!$loop->first)
                                 <li>
                                    <a href="{{route('candidate_project_move_up',['id'=>$value->id])}}">Move up</a>
                                 </li>
                                 @endif
                                 @if(!$loop->last)
                                 <li>
                                    <a href="{{route('candidate_project_move_down',['id'=>$value->id])}}">Move down</a>
                                 </li>
                                 @endif
                                 <li>
                                    <a href="" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                       ...
                                       <li>
                                          <a href="{{route('delete_candidate_project',['id'=>$value->id])}}" data-message="get" class="delete_candidate_project">Delete</a>
                                       </li>
                                    </ul>
                                 </li>
                              </ul>
                        ...
                        <div class="col-xs-12 education_list_form hidden">
                           <form class="form-horizontal add_eduation_form editprofileProjectsStore"  action="{{route('editprofileProjectsStore',['id'=>$value->id])}}"  method="post">
                              {{csrf_field()}}
                              <input type="hidden" name="user_id" value="{{Auth::user()->id}}">
                              <div class="form-group form-group-sm">
                                 <label class="col-sm-4 control-label">Project Name*</label>
                                 <div class="col-sm-4">
                                    <input type="text" class="form-control" placeholder="Project Name" value="{{$value->project_name}}" name="project_name">
                                 </div>
                                 <div class="control-label" style="text-align:initial">(Required)</div>
                              </div>
                              <div class="form-group form-group-sm">
                                 <label class="col-sm-4 control-label">Project URL</label>
                                 <div class="col-sm-4">
                                    <input type="text" class="form-control" placeholder="Project/related URL If any" value="{{$value->project_url}}" name="project_url">
                                 </div>
                              </div>
                              <div class="form-group form-group-sm">
                                 <label class="col-sm-4 control-label">Duration*</label>
               ...
               <ul class="ul_add">
                  ...
                  <li class="panel-block">
                     <div class="row">
                        <div class="education_list_data">
                           ...
                           <div class="col-xs-4">
                              <ul class="nav-links navbar-nav navbar-right">
                                 @if(!$loop->first)
                                 <li>
                                    <a href="{{route('candidate_publication_move_up',['id'=>$value->id])}}">Move up</a>
                                 </li>
                                 @endif
                                 @if(!$loop->last)
                                 <li>
                                    <a href="{{route('candidate_publication_move_down',['id'=>$value->id])}}">Move down</a>
                                 </li>
                                 @endif
                                 <li>
                                    <a href="" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                       ...
                                       <li>
                                          <a href="{{route('delete_candidate_publication',['id'=>$value->id])}}" data-message="get" class="delete_candidate_publication">Delete</a>
                                       </li>
                                    </ul>
                                 </li>
                              </ul>
                        ...
                        <div class="col-xs-12 education_list_form hidden">
                           <form class="form-horizontal add_eduation_form editprofilePublicationStore"  action="{{route('editprofilePublicationStore',['id'=>$value->id])}}"  method="post">
                              {{csrf_field()}}
                              <input type="hidden" name="user_id" value="{{Auth::user()->id}}">
                              <div class="form-horizontal">
                                 <div class="form-group form-group-sm">
                                 ...
                                 <div class="form-group form-group-sm">
                                    <label class="col-sm-4 control-label">URL*</label>
                                    <div class="col-sm-4">
                                       <input type="text" class="form-control" placeholder="URL" name="url" value="{{$value->url}}>
                                          </div>
                                          <div class="control-label" style="text-align:initial">(Required)
                                    </div>
                                 </div>
                                 <div class="form-group form-group-sm">
                                    <div class="col-sm-offset-4 col-sm-8">
               ...
               <ul class="">
                  ...
                  <li class="panel-block">
                     <div class="row">
                        <div class="education_list_data">
                           ...
                           <div class="col-xs-4">
                              <ul class="nav-links navbar-nav navbar-right">
                                 @if(!$loop->first)
                                 <li>
                                    <a href="{{route('candidate_achievement_move_up',['id'=>$value->id])}}">Move up</a>
                                 </li>
                                 @endif
                                 @if(!$loop->last)
                                 <li>
                                    <a href="{{route('candidate_achievement_move_down',['id'=>$value->id])}}">Move down</a>
                                 </li>
                                 @endif
                                 <li>
                                    <a href="" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                       ...
                                       <li>
                                          <a href="{{route('delete_candidate_achievement',['id'=>$value->id])}}" data-message="get" class="delete_candidate_achievement">Delete</a>
                                       </li>
                                    </ul>
                                 </li>
                              </ul>
                        ...
                        <div class="col-xs-12 education_list_form hidden">
                           <form class="form-horizontal add_eduation_form editprofileAchievementStore"  action="{{route('editprofileAchievementStore',['id'=>$value->id])}}"  method="post">
                              {{csrf_field()}}
                              <input type="hidden" name="user_id" value="{{Auth::user()->id}}">
                              <div class="form-horizontal">
                                 <div class="form-group form-group-sm">
                                    <label class="col-sm-4 control-label">Title*</label>
                                    <div class="col-sm-4">
                                       <input type="text" placeholder="Title" class="form-control" name="title" value="{{$value->title}}">
                                    </div>
                                    <div class="control-label" style="text-align:initial">(Required)</div>
                                 </div>
                                 <div class="form-group form-group-sm">
               ...
               <ul class="">
                  ...
                  <li class="panel-block">
                     ...
                     <div class="row">
                        ...
                        <div class="col-xs-9">
                           <a href="{{$Candidate_connection['linkedin_url']}}" target="_blank">{{$Candidate_connection['linkedin_url']}}</a>
                        </div>
                     </div>
                     @endif
                     ...
                     <div class="row">
                        ...
                        <div class="col-xs-9">
                           <a href="{{$Candidate_connection['facebook_url']}}" target="_blank">{{$Candidate_connection['facebook_url']}}</a>
                        </div>
                     </div>
                     @endif
                     ...
                     <div class="row">
                        ...
                        <div class="col-xs-9">
                           <a href="{{$Candidate_connection['github_url']}}" target="_blank">{{$Candidate_connection['github_url']}}</a>
                        </div>
                     </div>
                     @endif
                     ...
                     <div class="row">
                        ...
                        <div class="col-xs-9">
                           <a href="{{$Candidate_connection['twitter_url']}}" target="_blank">{{$Candidate_connection['twitter_url']}}</a>
                        </div>
                     </div>
                     @endif
                     ...
                     <div class="row">
                        ...
                        <div class="col-xs-9">
                           <a href="{{$Candidate_connection['website_url']}}" target="_blank">{{$Candidate_connection['website_url']}}</a>
                        </div>
                     </div>
                     @endif
                     @if(isset($Candidate_connection['website_url']))
